...
import {clearCart, removeCartItem} from "../redux/actions/cart-ac";
...
const Cart = () => {
    ...
    const {totalPrice, itemsCount, items} = useSelector(({cartReducer}) => cartReducer)
            ...
            {itemsCount
                ? <div className="cart">
                    ...
                    <div className="content__items">
                        {
                            addedPizzas.map(pizzaObj => <CartItem
                                id={pizzaObj.id}
                                name={pizzaObj.name}
                                type={pizzaObj.type}
                                size={pizzaObj.size}
                    ...
                    <div className="cart__bottom">
                        <div className="cart__bottom-details">
                            <span> Total pizzas: <b>{itemsCount} th.</b> </span>
                        ...
                        <div className="cart__bottom-buttons">
                            <Button className="button--add go-back-btn" outline>
                                ...
                                <Link to="/"><span>Come back</span></Link>
                            </Button>
